<font face="逐浪新宋" color=white size=10>1.复制</font>
```c++
#include <iostream>
...
```
<font face="逐浪新宋" color=white size=10>2.Fibonacci数列</font>
```c++
// 递归求法（自顶向下）
#include <iostream>
...
```
<font face="逐浪新宋" color=white size=10>3.超级楼梯</font>
```c++
// 递归求法（自顶向下）
// 递归求法（自顶向下）
#include <iostream>
...
```
<font face="逐浪新宋" color=white size=10>4.过滤多余的空格</font>
```c++
#include <iostream>
...
```
<font face="逐浪新宋" color=white size=10>5.幂次方</font>
```c++
#include <iostream>
...
```
<font face="逐浪新宋" color=white size=10>6.身份证排序</font>
```c++
#include <iostream>
#include <vector> // std::vector 为 C++ 中长度可变的数组，初始化时默认所有值为 0
...
```
<font face="逐浪新宋" color=white size=10>7.十进制转m进制</font>
```c++
#include <iostream>
...
```
<font face="逐浪新宋" color=white size=10>8.输出字母图形</font>
```c++
#include <iostream>
...
```
<font face="逐浪新宋" color=white size=10>9.数对</font>
```c++
#include <iostream>
...
```
<font face="逐浪新宋" color=white size=10>10.统计单词数</font>
```c++
#include <iostream>
#include <cctype>
...
```
<font face="逐浪新宋" color=white size=10>11.子序列和</font>
```c++
#include <iostream>
#include <vector> // std::vector 为 C++ 中长度可变的数组，初始化时默认所有值为 0
...
```
<font face="逐浪新宋" color=white size=10>12.最长上升子序列</font>
```c++
